...
export const URL_MOVIES_LATEST = URL_MOVIE + "/latest" + API_KEY_PARAM;
export const URL_MOVIES_POPULAR = URL_MOVIE + "/popular" + API_KEY_PARAM;
...
export const IMG_SIZE_XLARGE = "w500/";
